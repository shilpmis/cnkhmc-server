...
export default class extends BaseSchema {
  ...
  async up() {
    this.schema.alterTable(this.tableName, (table) => {
      ...
      table.unique(['leave_type_name', 'school_id', 'academic_year'], 'unique_leave_type_per_school_session')
    })
  }
  ...
  async down() {
    this.schema.alterTable(this.tableName, (table) => {
      ...
      table.dropUnique(['leave_type_name', 'school_id', 'academic_year'], 'unique_leave_type_per_school_session')
    })
  }
}
